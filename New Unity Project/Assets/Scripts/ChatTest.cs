...
namespace OpenAI
{
    public class ChatTest : MonoBehaviour
    {
        ...
        [SerializeField] private NPC_Dialog npcDialog;
        ...
        private void Start()
        {
            var message = new ChatMessage
            {
                Role = "user",
                Content =
                    "Act as a employee at a dutch supermarket in the given context and reply to the questions of the Player who talks to you.\n" +
